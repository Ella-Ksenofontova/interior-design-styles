...
export default function StyleCard({styleName, styleOrder, source}) {
    ...
    return (
        <div className={styles["style-image"]} style={{background: `url(/assets/styles_images/${styleName}/card.jpg) center / cover, url(/assets/styles_images/${styleName}/card.svg) center / cover, #F3DAB3 center / cover`}}>
